...
export const gymHealthFacts = [
    ...
    "Consistent sleep and wake times enhance recovery and optimize performance.",
    "Post-workout carbs help replenish glycogen and speed up recovery.",
    "BCAAs may reduce muscle soreness and support recovery during intense training.",
    "Dynamic stretching before workouts boosts mobility and primes your body for movement.",
    "Foam rolling can relieve muscle tightness and improve range of motion.",
    "Training with good form prevents injury and builds strength more efficiently.",
    "Cold showers or ice baths may reduce inflammation and aid post-exercise recovery.",
    "Limiting alcohol supports muscle recovery and improves sleep quality.",
    "Progressive overload—gradually increasing weight or reps—is key to building strength.",
    "Training different muscle groups on different days allows time for full recovery.",
    "Tracking your workouts helps ensure consistency and highlights progress.",
    "Mind-muscle connection enhances muscle activation and workout effectiveness.",
    "Training to failure too often can lead to burnout; balance intensity with recovery.",
    "Magnesium-rich foods like leafy greens help reduce cramps and support muscle function.",
    "Spending time outdoors can improve mood, vitamin D levels, and recovery.",
    "Proper footwear supports joint health and reduces risk of injury during exercise.",
]
